      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			...
			<table class="table table-bordered table-hover">
                ...
                <tr>
                	<td>
                    	#records_Blog_Categories.bc_category#
                    </td>
                    <td>
                    	<a href="crud_update.cfm?view_record=#records_Blog_Categories.blog_category_id#"><button name="view_record" type="button" class="btn btn-block btn-xs">Update</button></a>
                    </td>
                    <td>
