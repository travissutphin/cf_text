        ...
        <section class="content" style="min-height: 1200px;">
			...
			<div class="col-md-8">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        Preface:<br />
                        <input name="bi_name_preface" type="text" class="form-control" value="" />
                    </div>
                    
                    <div class="col-md-4">
                        Title:<br />
                        <input name="bi_title" type="text" class="form-control" value="" />
                    </div>		                            
                    ...
                    <div class="col-md-4">
                        First Name:<br />
                        <input name="bi_name_first" type="text" class="form-control" value="" />
                    </div>
                    
                    <div class="col-md-4">
                        Last Name:<br />
                        <input name="bi_name_last" type="text" class="form-control" value="" />
                    </div>		                            
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea id="txtarea" name="bi_content" rows="5" data-required="true" class="mceEditor"></textarea>
                    </div>
